...
이전에 했던 공부들은 결국 언젠가 한 번은 했을 공부라이기에 돌아왔단 생각은 하지 않습니다.
...
처음에는 "내가 머신러닝을 알면서 강의를 하는지", "하루 3시간 동안 유용한 내용로 강의를 구성할 수 있을지"에 대해 걱정을 하였습니다.
...
이를 통하여 조금이라도 머신러닝과 텍스트 마이닝을 공부하시는 분들이 효율적으로 공부하셨으면 하는 바람에서였습니다.
그리고 슬라이드 형식으로 전달하기 어려운 내용들은 블로그의 글로 정리하여 공유하기 시작하였습니다.

제가 가진 것들을 공유하자 다른 것들이 제게 되돌아오기 시작했습니다.
질문들은 제가 미숙하게 알던 것들을 짚어줬습니다.
무엇보다도 다른 이들과 소통하기 위하여 글을 준비하다보니 설명들은 조금씩 직관적이게 되었고, 알고리즘을 깊게 이해해야 하는 동기가 부여되었습니다.
...
교내에 교육을 도와주는 봉사 단체는 여럿 있었지만, 지역사회에 더 필요한 것은 교육이 아닌 사람 간의 관계망이라 생각하였습니다.
우리 사회에는 여러 이유로 하루의 많은 시간을 홀로, 또는 또래들과만 보내는 청소년들이 많습니다.
그들에게 더 필요한 것은 어느 때고 연락할 수 있는 "아는 동네 형"이라 생각하였습니다.
개인적인 이유로 활동을 그만하게 되었는데 여전히 어린 친구들이 계속 걱정되었습니다.
...
이 과제에서 사례 별 방법론 서베이 및 가이드라인 작업을 수행하였습니다.
...
토크나이징 과정에는 미등록단어 문제가 발생하거나 모호성이 발생할 때 분석하는 데이터의 패턴이 아닌 학습데이터의 패턴에 편향되는 문제가 발생합니다.
하지만 사람은 새로운 사건에 대한 뉴스나 새로운 분야의 텍스트에서 단어를 학습하고 모호성을 손쉽게 해결할 수 있습니다.
